...
// })
var score = 0;
var mathQuestions = ['Which of these is equal to 83.041?', 'A class of 25 students shares a class set of 100 markers. On a day with 5 students absent, which statement is true?', 'The area of a rectangular patio is 5/8 square yards, and its length is 1 1/2 yards. What is the patio\'s width, in yards?', 'Which expression is equal to 7/8 ?', 'Which expression represents "6 more than x"?'];
var correctAnswers = ['radio-choice-3', 'radio-choice-3', 'radio-choice-1', 'radio-choice-2', 'radio-choice-4'];
var radChoice1 = ['eighty-three and forty-one tenths', 'For every 5 students, there is 1 marker.', '3 <sup>3</sup>&frasl;<sub>4</sub>', '<sup>8</sup>&frasl;<sub>7</sub>', 'x - 6'];
var radChoice2 = ['8 &times; 10 + 3 &times; 1 + 4 &times; <sup>1</sup>&frasl;<sub>10</sub> + 1 &times; 1/100', 'For every 4 students, there is 1 marker.', '4 <sup>1</sup>&frasl;<sub>8</sub>', '7 &divide; 8', '6 &times; x'];
var radChoice3 = ['eighty-three and forty-one hundredths', 'For each student, there are 4 markers.', '7 <sup>1</sup>&frasl;<sub>8</sub>', '7 &times; 8', '6 - x'];
